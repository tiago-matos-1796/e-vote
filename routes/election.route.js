...
module.exports = app => {
    ...
    router.get('/manager', auth, access(["MANAGER"]), electionController.listByManager);
    router.get('/:id', auth, electionController.showBallot);
    router.get('/manager/:id', auth, access(["MANAGER"]), electionController.managerShow);
    router.post('/', auth, access(["MANAGER"]), electionController.create);
    ...
    router.patch('/:id', auth, access(["MANAGER"]), electionController.regenerateKeys);
